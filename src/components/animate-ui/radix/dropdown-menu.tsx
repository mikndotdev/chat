  ...
  return (
		<MotionHighlightItem disabled={disabled}>
			...
			>
				<motion.div
					className={cn(
						'relative z-[1] flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none [&_svg:not([class*= focus:text-accent-foreground data-[state=open]:text-accent-foreground [&:not([data-highlight])]:focus:bg-accent [&:not([data-highlight])]:data-[state=open]:bg-accent [&_[data-chevron]]:transition-transform [&_[data-chevron]]:duration-150 [&_[data-chevron]]:ease-in-out data-[state=open]:[&_[data-chevron]]:rotate-90'text-'])]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
						inset && "pl-8",
						className,
					)}
  ...
  return (
		<MotionHighlightItem disabled={disabled}>
			...
			>
				<motion.div
					className={cn(
						'relative flex cursor-default select-none items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden [&_svg:not([class*= focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&:not([data-highlight])]:focus:bg-accent'size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0',
						className,
					)}
					data-disabled={disabled}
